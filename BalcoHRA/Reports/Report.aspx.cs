...
namespace BalcoHRA.Reports
{
    public partial class Report : System.Web.UI.Page
    {
        ...
        protected void btnsearch_Click(object sender, EventArgs e)
        {
            ...
            string fromDate = Convert.ToDateTime(txtFromDate.Text).ToString("yyyy-MM-dd hh:mm:ss tt");
            string toDate = Convert.ToDateTime(txtToDate.Text).ToString("yyyy-MM-dd hh:mm:ss tt");


            DataTable dt = cn.Bind_Report(fromDate, toDate);
