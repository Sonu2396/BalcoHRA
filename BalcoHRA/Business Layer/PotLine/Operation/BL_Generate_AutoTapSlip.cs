...
{
    public class BL_Generate_AutoTapSlip
    {
        FPManager cn = new FPManager();

        #region Generate  Slip Start

        public DataTable Generate_Tapping_Slip()
        {
            DataTable dt = new DataTable();
            dt = cn.GetDataTable("SP_POTLINE_OPERATION_GENERATE_SLIP_STEP0");
            return dt;
        }

        public DataTable Fetch_Line_Section(string Date, string Shift, string Location)
        {
            DataTable dt = new DataTable();
            dt = cn.GetDataTable("SP_POTLINE_OPERATION_GENERATE_SLIP_STEP1"
             , new string[] { "@TAPDATE", "@TAPSHIFT", "@LOCATION", }
                , new string[] { Date, Shift, Location });
            return dt;
        }
        public DataTable Fetch_Blend_Pot(string Position, string LineSec, string Date, string Shift, string Fe, string Si, string Purity, string SortOrder, string Location )
        {
            DataTable dt = new DataTable();
            dt = cn.GetDataTable("SP_POTLINE_OPERATION_GENERATE_SLIP_STEP3"
             , new string[] { "@POSITION", "@LINESEC", "@TAPDATE", "@TAPSHIFT", "@FE", "@SI", "@Purity", "@SORTORDER", "@LOCATION" }
                , new string[] { Position, LineSec, Date, Shift, Fe, Si, Purity, SortOrder, Location });
            return dt;
        ...
        {
            DataTable dt = new DataTable();
            dt = cn.GetDataTable("SP_POTLINE_OPERATION_GENERATE_SLIP_MERGE_POT"
        ...
        {
            DataTable dt = new DataTable();
            dt = cn.GetDataTable("SP_POTLINE_OPERATION_GENERATE_SLIP_STEP4"
        ...
        {
            DataTable dt = new DataTable();
            dt = cn.GetDataTable("SP_POTLINE_OPERATION_GENERATE_SLIP_STEP5"
             , new string[] { "@TAPDATE", "@TAPSHIFT", "@POTID", "@FID", "@SLIPNO", "@FFE", "@FSI", "@FPURITY", "@FGRADE", "@FTOTWT", "@ISSUEWT" }
                , new string[] { TAPDATE, TAPSHIFT, POTID, FID, SLIPNO, FFE, FSI, FPURITY, FGRADE, FTOTWT, ISSUEWT });
            return dt;

        }
        public DataTable Blending_Potsamegrade_PotLine1(DataTable dvpotdsc, DataTable dvpotdscMIX, int SLNo, int PotLine)
        {
        ...
        public DataTable Blending_Potsamegrade_PotLine2(DataTable dvpotdsc, DataTable dvpotdscMIX, int SLNo, int PotLine)
        {
        ...
        public DataTable Final_Blending2Potsamegrade(DataTable dvpotdsc, int SLNo, int PotLine)
        ...
        public void FurnacePlanAssignBack(string shiftdate, string shift, string SortOrder)
        {
            ...
            DataTable DTFurnace = cn.GetDataTable("SP_POTLINE_OPERATION_GENERATE_SLIP_STEP2"
            ...
            for (int i = 0; i < DTFurnace.Rows.Count; i++)
            {
                ...
                string Location = DTFurnace.Rows[i]["LOCATION"].ToString();

                DataTable DTLineSec = Fetch_Line_Section(shiftdate, shift, Location);
                ...
                for (int j = 0; j < DTLineSec.Rows.Count; j++)
                {
                    ...
                    //Blend Pot List
                    DataTable DTPot = Fetch_Blend_Pot("BACK", DTLineSec.Rows[j]["LINESECTIONSIDE"].ToString(), shiftdate, shift, PFE.ToString(), PSI.ToString(), PPurity.ToString(), SortOrder, Location);
                    ...
                    // Mix Pot List
                    DataTable DTMIXPot = Fetch_Blend_Pot("BACK", DTLineSec.Rows[j]["LINESECTIONSIDE"].ToString(), shiftdate, shift, PFE.ToString(), PSI.ToString(), PPurity.ToString(), SortOrder, Location);
                    ...
                    {
                        DTBlend = Blending_Potsamegrade_PotLine1(DVPot.Table, DVMIXPot.Table, SLNO, int.Parse(PotLine));
                    }
                    else if (int.Parse(PotLine) == 2)
                    {
                        DTBlend = Blending_Potsamegrade_PotLine2(DVPot.Table, DVMIXPot.Table, SLNO, int.Parse(PotLine));
                    }
                    ...
                    Dt4 = Final_Blending2Potsamegrade(DVPot.Table, SLNO, int.Parse(PotLine));
                    if (Dt4.Rows.Count > 0)
                    {
        ...
        public void FurnacePlanAssignBack_Balanced(string ShiftDate, string Shift, string SortOrder)
        {
            ...
            for (int i = 0; i < DTFurnace.Rows.Count; i++)
            {
                ...
                for (int j = 0; j < DTLineSec.Rows.Count; j++)
                {
                    ...
                    if (int.Parse(PotLine) == 1)
                    {
                        DTBlend = Blending_Potsamegrade_Balanced_Potline1(DVMIXPot.Table, DVMIXPot.Table, SLNO, int.Parse(PotLine));
                    }
                    else if (int.Parse(PotLine) == 2)
                    {
                        DTBlend = Blending_Potsamegrade_Balanced_Potline2(DVMIXPot.Table, DVMIXPot.Table, SLNO, int.Parse(PotLine));
                    }
                    ...
                    Dt4 = Final_Blending2Potsamegrade(DVMIXPot.Table, SLNO, int.Parse(PotLine));
                    if (Dt4.Rows.Count > 0)
                    {
        ...
        public DataTable Blending_Potsamegrade_Balanced_Potline1(DataTable dvpotdsc, DataTable dvpotdscMIX, int SLNo, int PotLine)
        {
        ...
        public DataTable Blending_Potsamegrade_Balanced_Potline2(DataTable dvpotdsc, DataTable dvpotdscMIX, int SLNo, int PotLine)
        {
        ...
        public void FurnacePlanAssignBack_Balanced_MergePotWith_Slipno(string shiftdate, string shift)
        {
            ...
            DataView DVMIXPot = new DataView();
            DataTable DTMIXPot = cn.GetDataTable("SP_POTLINE_OPERATION_GENERATE_SLIP_BALANCE_MERGE_POT"
             , new string[] { "@TAPDATE", "@TAPSHIFT" }
                , new string[] { shiftdate, shift });
            ...
            for (int m = 0; m <= DTMIXPot.Rows.Count - 1; m++)
            {
                ...
                DataTable dt = new DataTable();
                cn.ExecuteQuerySP("SP_POTLINE_OPERATION_GENERATE_SLIP_UPDATE_BALANCE_MERGE_POT"
        ...
        public DataTable Slip_Info(string Tapdate, string TapShift)
        {
            ...
            cn.ExecuteQuerySP("SP_POTLINE_OPERATION_GENERATE_SLIP_STEP7"
                , new string[] { "@TAPDATE", "@TAPSHIFT" }
                   , new string[] { Tapdate, TapShift });
            ...
            DataTable dt = new DataTable();
            dt = cn.GetDataTable("SP_POTLINE_OPERATION_GENERATE_SLIP_LIST"
                , new string[] { "@TAPDATE", "@TAPSHIFT" }
                   , new string[] { Tapdate, TapShift });
