<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="MasterCriticalLift.aspx.cs"  Inherits="BalcoHRA.ChecklistMaster.MasterCriticalLift" %>
        ...
        $(document).ready(function(){
            $('.dataTables-example').DataTable({
                ...
                buttons: [
                    { extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'Critical Lift'},
                    {extend: 'pdf', title: 'Critical Lift'},
            ...
            <div class="col-lg-12">
                <div class="ibox ">
                        <div class="ibox-title">
                            <h5>Critical Lift Master<asp:Label runat="server" ID="lbltransid" Visible="false"></asp:Label></h5>
