<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="MasterExcavation.aspx.cs"  Inherits="BalcoHRA.ChecklistMaster.MasterExcavation" %>
        ...
        $(document).ready(function(){
            $('.dataTables-example').DataTable({
                ...
                buttons: [
                    { extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'Excavation'},
                    {extend: 'pdf', title: 'Excavation'},
            ...
            <div class="col-lg-12">
                <div class="ibox ">
                        <div class="ibox-title">
                            <h5>Excavation Master<asp:Label runat="server" ID="lbltransid" Visible="false"></asp:Label></h5>
