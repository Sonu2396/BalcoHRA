<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="MasterWAH.aspx.cs"  Inherits="BalcoHRA.ChecklistMaster.MasterWAH" %>
        ...
        $(document).ready(function(){
            $('.dataTables-example').DataTable({
                ...
                buttons: [
                    { extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'Work At Height'},
                    {extend: 'pdf', title: 'Work At Height'},
            ...
            <div class="col-lg-12">
                <div class="ibox ">
                        <div class="ibox-title">
                            <h5>Work At Height Master<asp:Label runat="server" ID="lbltransid" Visible="false"></asp:Label></h5>
