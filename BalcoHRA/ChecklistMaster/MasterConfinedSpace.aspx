<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="MasterConfinedSpace.aspx.cs"  Inherits="BalcoHRA.ChecklistMaster.MasterConfinedSpace" %>
        ...
        $(document).ready(function(){
            $('.dataTables-example').DataTable({
                ...
                buttons: [
                    { extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'Confined Space'},
                    {extend: 'pdf', title: 'Confined Space'},
            ...
            <div class="col-lg-12">
                <div class="ibox ">
                        <div class="ibox-title">
                            <h5>Confined Space Master<asp:Label runat="server" ID="lbltransid" Visible="false"></asp:Label></h5>
