<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="MasterISO.aspx.cs"  Inherits="BalcoHRA.ChecklistMaster.MasterISO" %>
        ...
        $(document).ready(function(){
            $('.dataTables-example').DataTable({
                ...
                buttons: [
                    { extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'ISO'},
                    {extend: 'pdf', title: 'ISO'},
            ...
            <div class="col-lg-12">
                <div class="ibox ">
                        <div class="ibox-title">
                            <h5>Isolation Master<asp:Label runat="server" ID="lbltransid" Visible="false"></asp:Label></h5>
