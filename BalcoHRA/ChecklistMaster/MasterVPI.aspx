<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="MasterVPI.aspx.cs"  Inherits="BalcoHRA.ChecklistMaster.MasterVPI" %>
        ...
        $(document).ready(function(){
            $('.dataTables-example').DataTable({
                ...
                buttons: [
                    { extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'VPI'},
                    {extend: 'pdf', title: 'VPI'},
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      ...
      <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Vehicle & Pedestrain Interaction Master</h2>
                    <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
                <div class="ibox ">
                        <div class="ibox-title">
                            <h5>Vehicle & Pedestrain Interaction Master<asp:Label runat="server" ID="lbltransid" Visible="false"></asp:Label></h5>
                        ...
                        <div class="ibox-content">
                            ...
                            <div class=" row form-group"> 
                                ...
                                <div class="col-lg-2"><label>Critical Control</label><label style="color:red">*</label> </div>
                                 <div class="col-lg-6">
                                     <asp:TextBox runat="server" ID="txtCriticalControl"  placeholder="Critical Control" class="form-control" TabIndex="2"></asp:TextBox>
                                 </div>
                                
                                <div class="col-lg-2"><label>Objective</label><label style="color:red">*</label> </div>
                                 <div class="col-lg-6">
                                     <asp:TextBox runat="server" ID="txtObjective"  placeholder="Objective" class="form-control" TabIndex="2"></asp:TextBox>
                                 </div>
                                
                                <div class="col-lg-2"><label>Points</label><label style="color:red">*</label> </div>
                                 <div class="col-lg-6">
                                     <asp:TextBox runat="server" ID="txtPoints"  placeholder="Points" class="form-control" TabIndex="2"></asp:TextBox>
                                 </div>
     ...
     <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            <asp:Panel runat="server" ID="PnlView" Visible="true">
                ...
                <div class="ibox ">
                        <div class="ibox-title">
                            <h5>Vehicle & Pedestrain Interaction Master</h5>
                            <div class="ibox-tools">
                            <a class="collapse-link">
                                <i class="fa fa-chevron-up"></i>
                            </a>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td style="width:30%">
                            <asp:Label ID="lblCriticalControl" runat="server" Text='<%# Eval("CriticalControl") %>'></asp:Label>
                        </td>
                        <td style="width:30%">
                        ...
                        <td style="width:10%">
                           <div class="btn-group">
                               <asp:LinkButton ID="lnkbtnedit" CommandName="Edit" CommandArgument='<%# Eval("CID") %>'  runat="server" ToolTip="Edit" OnClick="lnkbtnedit_Click"><i class="btn btn-primary fa fa-edit"> </i></asp:LinkButton>
                               <asp:LinkButton ID="lnkbtndelete" CommandName="Delete" CommandArgument='<%# Eval("CID") %>'  runat="server" ToolTip="Delete" OnClick="lnkbtndelete_Click" OnClientClick="javascript:return confirm('Are you sure you want to delete this?');"><i class="btn btn-danger fa fa-trash"></i></asp:LinkButton>
                           </div>
