<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="MasterArea.aspx.cs" Inherits="BalcoHRA.Master.MasterDept" %>
        ...
        $(document).ready(function(){
            $('.dataTables-example').DataTable({
                ...
                buttons: [
                    { extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'Dept'},
                    {extend: 'pdf', title: 'Dept'},
            ...
            <div class="col-lg-12">
                <div class="ibox ">
                        <div class="ibox-title">
                            <h5>Area Master<asp:Label runat="server" ID="lbltransid" Visible="false"></asp:Label></h5>
                        ...
                        <div class="ibox-content">
                            ...
                            <div class=" row form-group"> 
                                ...
                                <div class="col-lg-2"><label>Area Name</label><label style="color:red">*</label> </div>
                                 <div class="col-lg-6">
                                     <asp:TextBox runat="server" ID="txtname"  placeholder="Dept Name" class="form-control" TabIndex="2"></asp:TextBox>
                                 </div>

                                <div class="col-lg-2"></div>
                                <div class="col-lg-2"><label>SBU Name</label><label style="color:red">*</label> </div>
                                 <div class="col-lg-6">
                                     <asp:TextBox runat="server" ID="TextSBU"  placeholder="SBU Name" class="form-control" TabIndex="3"></asp:TextBox>
                                 </div>
            ...
            <asp:Panel runat="server" ID="PnlView" Visible="true">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td style="width:40%">
                            <asp:Label ID="LabelSBU" runat="server" Text='<%# Eval("SBUName") %>'></asp:Label>
                        </td>
                       
                        
                        <td style="width:10%">
                           <div class="btn-group">
                               <asp:LinkButton ID="lnkbtnedit" CommandName="Edit" CommandArgument='<%# Eval("DepartmentID") %>'  runat="server" ToolTip="Edit" OnClick="lnkbtnedit_Click"><i class="btn btn-primary fa fa-edit"> </i></asp:LinkButton>
                               <asp:LinkButton ID="lnkbtndelete" CommandName="Delete" CommandArgument='<%# Eval("DepartmentID") %>'  runat="server" ToolTip="Delete" OnClick="lnkbtndelete_Click" OnClientClick="javascript:return confirm('Are you sure you want to delete this?');"><i class="btn btn-danger fa fa-trash"></i></asp:LinkButton>
                           </div>
