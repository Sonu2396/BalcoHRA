...
{
    public partial class MasterSBU : System.Web.UI.Page
    {
        BL_SBU cn = new BL_SBU();
        ...
        protected void btnsave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                String Result = cn.SBU_Save(txtname.Text, lblUserid.Text, "Save");
        ...
        protected void lnkbtndelete_Click(object sender, EventArgs e)
        {
            ...
            String Result = cn.SBU_Delete(ID, lblUserid.Text, "Delete");
        ...
        protected void btnupdate_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                String Result = cn.SBU_Update(lbltransid.Text, txtname.Text, lblUserid.Text, "Update");
