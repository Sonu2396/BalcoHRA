...
{
    public partial class MasterActivity : System.Web.UI.Page
    {
        BL_Activity cn = new BL_Activity();
        ...
        {
            DataTable dt = cn.Get_ActivityList();
        ...
        protected void btnsave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                String Result = cn.Activity_Save(txtname.Text, lblUserid.Text, "Save");
        ...
        protected void lnkbtndelete_Click(object sender, EventArgs e)
        {
            ...
            String Result = cn.Activity_Delete(ID, lblUserid.Text, "Delete");
        ...
        protected void btnupdate_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                String Result = cn.Activity_Update(lbltransid.Text, txtname.Text, lblUserid.Text, "Update");
