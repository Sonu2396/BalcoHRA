...
{
    public partial class MasterDept : System.Web.UI.Page
    {
        BL_Area cn = new BL_Area();
        ...
        {
            DataTable dt = cn.Get_DepartmentList();
        ...
        protected void btnsave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                String Result = cn.Department_Save(txtname.Text, TextSBU.Text, lblUserid.Text, "Save");
        ...
        protected void lnkbtndelete_Click(object sender, EventArgs e)
        {
            ...
            String Result = cn.Department_Delete(ID, lblUserid.Text, "Delete");
        ...
        protected void btnupdate_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                String Result = cn.Department_Update(lbltransid.Text, txtname.Text, TextSBU.Text, lblUserid.Text, "Update");
