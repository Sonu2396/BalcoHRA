...
{
    public partial class MasterUserRole : System.Web.UI.Page
    {
        BL_Role cn = new BL_Role();
        ...
        protected void btnsave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                String Result = cn.Role_Save(txtname.Text,  lblUserid.Text, "Save");
        ...
        protected void lnkbtndelete_Click(object sender, EventArgs e)
        {
            ...
            String Result = cn.Role_Delete(ID, lblUserid.Text, "Delete");
        ...
        protected void btnupdate_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                String Result = cn.Role_Update(lbltransid.Text, txtname.Text, lblUserid.Text, "Update");
