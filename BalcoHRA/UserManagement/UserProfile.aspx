<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="UserProfile.aspx.cs" Inherits="BalcoHRA.UserManagement.UserProfile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        ...
        <div class="wrapper wrapper-content">
                        ...
                        <div>
                            ...
                            <div class="ibox-content profile-content">
                                ...
                                <div class="user-button">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <asp:LinkButton runat="server" ID="lbkbtnchangepassword" CssClass="btn btn-primary btn-sm btn-block" PostBackUrl="~/UserManagement/User_ChangePassword.aspx" Visible="false"><i class="fa fa-envelope"></i> Change Password</asp:LinkButton>
                                        </div>
         ...
         <Triggers>
             <asp:PostBackTrigger ControlID="lbkbtnchangepassword" />
